...
<div class="main">
	...
	<table class="table we7-table table-hover site-list" id="system-info" ng-controller="systemInfoCtrl" ng-cloak>
		...
		<tr>
			...
			<td class="text-left">WeEngine <?php  echo IMS_VERSION;?> Release <?php  echo IMS_RELEASE_DATE;?> &nbsp; &nbsp;
				<a href="http://wpa.qq.com/msgrd?v=3&uin=2711815014&site=qq&menu=yes" target="_blank" style="color: #428bca;">查看最新版本</a>
			</td>
		</tr>
		<tr>
	...
	<table class="table we7-table table-hover site-list">
		...
		<tr>
			...
			<td>
				<a target="_blank" href="http://s.we7.cc/" style="color: #428bca;">系统</a>
			</td>
		</tr>
		<tr>
			<td class="text-left">相关链接</td>
			<td>
				<a href="http://s.we7.cc/" class="lightlink2" target="_blank" style="color: #428bca;">公司网站</a>&nbsp;&nbsp;
				<a href="http://s.we7.cc/" class="lightlink2" target="_blank" style="color: #428bca;">购买授权</a>&nbsp;&nbsp;
				...
				<a href="http://s.we7.cc/" class="lightlink2" target="_blank" style="color: #428bca;">讨论区</a>
			</td>
		</tr>
	</table>
	<?php  } ?>
